...
describe('L5 Type Inference', () => {
    describe('inferTypeOf', () => {
        it('infers the type of atomic expressions', () => {
        ...
        it('(3.1 1pts) infers the type of "define" expressions as "void"', () => {
        ...
        it('(3.1 1pts) infers the type of "define" expressions - failure cases', () => {
            expect(inferTypeOf(`(define (x : boolean) (+ x x))`)).to.satisfy(isFailure);
            expect(inferTypeOf(`(define x (+ x #t))`)).to.satisfy(isFailure);
            expect(inferTypeOf(`(define fact (lambda (n) (if (= n 0) 1 (* n (fact (- n 1))))))`)).to.deep.equal(makeOk("void"));
            expect(inferTypeOf(`(define fact (lambda (n) (if (= n 0) 1 (* n (fact1 (- n 1))))))`)).to.satisfy(isFailure);
        });
    ...
    describe('typeOfExp', () => {
        ...
        it('(3.1 1pts) infers the type of a program with define and recursion', () => {
            ...
            expect(verifyTeOfExprWithInference(`(L5 (define n #t) (+ n n))`, 'void')).to.satisfy(isFailure);
        });

        it('(3.1 2pts) infers the type of set! expressions', () => {
            const program1 = 
            `(L5 (define x 1)
                 (set! x 2))`;
        ...
        it('(3.1 1pts) set! expressions work on defined variables', () => {
            const program3 = 
            `(L5 (set! x #t))`;
            expect(verifyTeOfExprWithInference(program3, `Error`)).to.satisfy(isFailure);
        });

        it('(3.1 2pts) infers the type of quoted literal expressions', () => {
            const program1 = 
            `(L5 (define x 'a)
                 x)`;
        ...
        it('(3.2 2pts) infers the type of primitives car, cdr, cons', () => {
            const program1 = 
            `(L5 (define x 'a)
                 (cons x x))`;
        ...
        it('(3.2 1pts) infers the type of primitives car, cdr, cons', () => {
            expect(verifyTeOfExprWithInference(`cons`, `(T1 * T2 -> cons)`)).to.deep.equal(makeOk(true));
            expect(verifyTeOfExprWithInference(`car`, `(cons -> T)`)).to.deep.equal(makeOk(true));
            expect(verifyTeOfExprWithInference(`cdr`, `(cons -> T)`)).to.deep.equal(makeOk(true));
        });

        it('(3.3.4c 1pts) infers the type of class', () => {
        ...
        it('(3.3.4c 2pts) infers the type of a class constructor', () => {
            const program1 = 
        ...
        it('(3.3.4d 3pts) infers the type of a class with typed class define', () => {
            const program1 = 
        ...
        it('(3.3.4a 2pts) infers the type of a class method invocation', () => {
            const program3 = 
            `(L5 (define pair (class : pair 
                                ((f : T) 
                                 (r : T))
        ...
        it('(3.3.4a 2pts) returns an error when a message is passed to a class that is not in its interface', () => {
            const program5 = 
            `(L5 (define pair (class : pair 
                                ((f : T) 
                                 (r : T))
        ...
        it('(3.3.4b 4pts) infers the type of functions that receive class as parameters or return methods', () => {
            const program5 = 
            `(L5 (define pair (class : pair 
                                ((f : T) 
                                 (r : T))
